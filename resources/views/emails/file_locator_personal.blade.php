...
<head>
    ...
    <title>New Personal File Locator</title>
</head>
<body>
    <div class="header">
        <div class="header-title">HRIS &mdash; File Locator (Personal)</div>
        <div class="header-sub">Human Resource Information System</div>
    </div>
    <div class="container">
        <p>Dear <strong>{{ $employee->dept_head_name ?? 'Department Head' }}</strong>,</p>

        <p><strong>{{ trim(($employee->first_name ?? '') . ' ' . ($employee->middle_name ?? '') . ' ' . ($employee->last_name ?? '')) }}</strong> from your department has filed a new Personal File Locator application.</p>
        ...
        <div class="card">
            ...
            <ul>
                ...
                <li><strong>Purpose:</strong> Personal</li>
