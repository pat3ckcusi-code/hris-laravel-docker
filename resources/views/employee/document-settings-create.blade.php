@extends('dashboards.layout', [
    ...
    'subtitle' => 'Define a new document template.',
])
...
.img-preview { max-width: 260px; max-height: 80px; border: 1px solid #e5e7eb; border-radius: 4px; margin-bottom: 8px; display: none; }
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                ...
                <div class="fg">
                    ...
                    <input type="text" id="salutation" name="salutation"
                           ...
                           value="{{ old('salutation', 'To Whom It May Concern:') }}">
        ...
        <div class="fs">
            ...
            <div class="font-bar">
                <select name="closing_remark_font" title="Font family">
                    @foreach($fonts as $f)
                        <option value="{{ $f }}" {{ old('closing_remark_font','Arial') === $f ? 'selected' : '' }}>{{ $f }}</option>
                    @endforeach
                </select>
                <input type="number" name="closing_remark_size" min="6" max="72"
                       value="{{ old('closing_remark_size', 12) }}" title="Font size (pt)">
                <input type="color" name="closing_remark_color"
                       value="{{ old('closing_remark_color', '#000000') }}" title="Font color">
                <span class="sep">|</span>
                <label title="Bold"><input type="checkbox" name="closing_remark_bold" value="1"
                    {{ old('closing_remark_bold') ? 'checked' : '' }}> <strong>B</strong></label>
                <label title="Italic"><input type="checkbox" name="closing_remark_italic" value="1"
                    {{ old('closing_remark_italic') ? 'checked' : '' }}> <em>I</em></label>
                <label title="Underline"><input type="checkbox" name="closing_remark_underline" value="1"
                    {{ old('closing_remark_underline') ? 'checked' : '' }}> <u>U</u></label>
            </div>
            <textarea name="closing_remark_text"
                      class="fctl @error('closing_remark_text') is-invalid @enderror"
                      rows="3"
                      placeholder="e.g., Given this {date} in Calapan City upon the request of {employee_name}.">{{ old('closing_remark_text') }}</textarea>
    ...
    function buildRow(d) {
        ...
        el.innerHTML = `
            ...
            <div class="font-bar" style="margin-bottom:10px;">
                ...
                <span class="sep">|</span>
                <label><input type="checkbox" name="signatories[${i}][name_bold]" value="1" checked> <strong>B</strong></label>
                <label><input type="checkbox" name="signatories[${i}][name_italic]" value="1"> <em>I</em></label>
            </div>
            ...
            <div class="font-bar">
                ...
                <span class="sep">|</span>
                <label><input type="checkbox" name="signatories[${i}][desig_italic]" value="1" checked> <em>I</em></label>
            </div>
        `;
