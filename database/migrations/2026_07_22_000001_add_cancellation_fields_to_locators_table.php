...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('locators', function (Blueprint $table) {
            ...
            $table->text('cancellation_review_remarks')->nullable()->after('cancellation_reason');
            $table->timestamp('cancellation_requested_at')->nullable()->after('cancellation_review_remarks');
