...
class AdministrativeOfficerController extends Controller
{
    ...
    public function approvedRequests(Request $request)
    {
        ...
        $locatorRecordArrivalBaseUrl = url('admin-officer/locator');
    ...
    public function approveLocatorCancellation(Request $request, $id)
    {
        ...
        try {
            ...
            Log::error('Failed to write HRAuditTrail for Locator cancellation approval (AO)', ['locator_id' => $locator->id, 'error' => $ex->getMessage()]);
        }
        ...
        try {
            ...
            Log::error('Error sending locator cancellation approval email (AO)', ['locator_id' => $locator->id, 'error' => $e->getMessage()]);
        }
    ...
    public function rejectLocatorCancellation(Request $request, $id)
    {
        ...
        try {
            ...
            Log::error('Failed to write HRAuditTrail for Locator cancellation rejection (AO)', ['locator_id' => $locator->id, 'error' => $ex->getMessage()]);
        }
        ...
        try {
            ...
            Log::error('Error sending locator cancellation rejection email (AO)', ['locator_id' => $locator->id, 'error' => $e->getMessage()]);
        }
