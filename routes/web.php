...
Route::middleware(['auth', 'role:hr-manager,time-keeper'])->group(function () {
    ...
    Route::get('/dashboard/hr-manager/attendance/import/unmatched-data', [AttendanceImportController::class, 'unmatchedPunchesData'])
        ->name('hr-manager.attendance.import.unmatched-data');
...
Route::middleware(['auth', 'role:time-keeper,hr-manager,administrative-officer,department-head'])->group(function () {
    ...
    Route::post('/attendance/shift-schedule/single-day', [ShiftScheduleController::class, 'storeSingleDay'])
        ->name('attendance.shift-schedule.store-single-day');
